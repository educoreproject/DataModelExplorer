...
// Auto-generated search CLI for DCTAP in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: dctap_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
