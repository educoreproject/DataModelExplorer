...
// Auto-generated search CLI for UseCases in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: usecase_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
