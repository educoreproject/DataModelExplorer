...
// Auto-generated search CLI for PESC in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: pesc_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
