...
// Auto-generated search CLI for CIP in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: cip_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
