...
// Auto-generated search CLI for EdFi in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: edfi_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
