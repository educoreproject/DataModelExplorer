...
// Auto-generated search CLI for SIF in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: sif_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
