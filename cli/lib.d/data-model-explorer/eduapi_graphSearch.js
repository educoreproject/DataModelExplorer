...
// Auto-generated search CLI for EduApi in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: eduapi_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
