...
// Auto-generated search CLI for SEDM in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: sedm_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
