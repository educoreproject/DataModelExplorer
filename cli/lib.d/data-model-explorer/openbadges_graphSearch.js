...
// Auto-generated search CLI for OpenBadges in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: openbadges_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
