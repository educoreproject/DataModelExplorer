...
// Auto-generated search CLI for CTDL in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: ctdl_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
