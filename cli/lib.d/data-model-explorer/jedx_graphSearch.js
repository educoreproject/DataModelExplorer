...
// Auto-generated search CLI for JEDx in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: jedx_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
