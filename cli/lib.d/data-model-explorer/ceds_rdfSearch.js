...
// Auto-generated search CLI for CEDS in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: ceds_rdfSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
