...
// Auto-generated search CLI for CLR in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: clr_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
