...
// Auto-generated search CLI for LIF in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: lif_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
