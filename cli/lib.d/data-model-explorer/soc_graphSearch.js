...
// Auto-generated search CLI for SOC in DME context
...
if (switches.search || getVal('query')) {
	...
	console.log('Usage: soc_graphSearch -search --query="..." | -stats | -rawCypher --query="CYPHER" | -explore --name="..." | -history');
}
