...
const examplePrompts = [
	...
	"I'm a non-technical user and I want to learn more about SEDM that I've heard of. Can I use it if my state is using Ed-Fi?",
	"I'm trying to implement an LER marketplace, how do I do that. Show me use cases and specifications.",
];
