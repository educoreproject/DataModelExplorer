...
export const useEdMatrixStore = defineStore('edMatrixStore', {
	state: () => ({
		...
		rawData: [
			...
			{ name: 'SIF Data Model', org: 'A4L', types: ['Organizational', 'Personal', 'Event', 'Achievement'], dataLayers: [1, 2, 3], uses: ['LRMI'], url: 'https://data.a4l.org/', excerpt: '<p>Data model for educational information.</p>' },
			{ name: 'SIF Infrastructure', org: 'A4L', types: ['Organizational', 'Personal', 'Event', 'Achievement'], dataLayers: [4], uses: ['XML', 'JSON', 'HTTP'], url: 'https://data.a4l.org/', excerpt: '<p>Protocol for transmitting educational information.</p>' },
